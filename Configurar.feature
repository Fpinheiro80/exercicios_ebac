...
Quando selecionar uma cor disponivel, selecionar um tamanho
...
E o sistema deve exibir uma mensagem informando que esses campos são obrigatorios
...
E o sistema não deve permitir a seleção
