            ...
            Quando preencher todos os campos e informar o <nome>,<sobrenome>,<telefone>,<e-mail>
            ...
            E deve exibir uma mensagem de alerta informando que o campo é obrigatório.
            Exemplos:
            | Nome    |  | E-mail             |  | Endereço         |
            | "pedro" |  | "vazio"            |  | "rua joão paulo" |
            | "vazio" |  | "joão@gmail.com"   |  | "rua dom pedro"  |
            | "paulo" |  | "josias@gmail.com" |  | "vazio"          |